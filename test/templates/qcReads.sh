...
# contaminants files
contaminants=$CONDA_BASE/envs/trimReads/opt/fastqc*/Configuration/contaminant_list.txt
adapters=$CONDA_BASE/envs/trimReads/opt/fastqc*/Configuration/adapter_list.txt
